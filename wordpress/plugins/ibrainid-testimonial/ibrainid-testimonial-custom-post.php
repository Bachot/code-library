<?php
add_action( 'init', 'ibrainid_execute_team_custom_post');
function ibrainid_execute_team_custom_post() { 
	$custom_path = ibrainid_team_settings_custom_path();
	ibrainid_set_team_custom_post( 'ibrainid_team', 'ibrainiD', $custom_path );
}
function ibrainid_set_team_custom_post( $obj, $name, $slug ) {
	...
	$labels = array(
		...
		'menu_name'             => __( $name . ' Teams', 'text_domain' ),
		'name_admin_bar'        => __( $name . ' Teams', 'text_domain' ),
